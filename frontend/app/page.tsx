...
const STEPS = [
  {
    num: '۰۱',
    title: 'ثبت درخواست',
    desc: 'خریدار اطلاعات ملک و شرایط مالی را ثبت می‌کند',
    icon: (
  ...
  {
    num: '۰۲',
    title: 'اعتبارسنجی بانک',
    desc: 'بانک شرایط متقاضی را بررسی و وام را تأیید می‌کند',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    num: '۰۳',
    title: 'ارزیابی ملک',
    desc: 'شرکت تثمین گزارش رسمی ارزش ملک را صادر می‌کند',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    num: '۰۴',
    title: 'تکمیل معامله',
    desc: 'اتصال طرفین و دریافت وجه توسط فروشنده',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
...
const ACTORS = [
  { role: 'خریدار', desc: 'متقاضی خرید و دریافت وام', gradient: 'from-blue-500 to-cyan-400', icon: '🏠' },
  { role: 'فروشنده', desc: 'مالک ملک و دریافت وجه', gradient: 'from-emerald-500 to-teal-400', icon: '💰' },
  { role: 'بانک', desc: 'تأمین مالی و اعتبارسنجی', gradient: 'from-amber-500 to-orange-400', icon: '🏦' },
  { role: 'ارزیاب', desc: 'ارزش‌گذاری رسمی ملک', gradient: 'from-violet-500 to-purple-400', icon: '📋' },
];
    ...
    <div className="min-h-screen relative">
      ...
      <header className="fixed top-0 inset-x-0 z-50 glass border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/login" className="btn-secondary text-sm hidden sm:inline-flex">ورود</Link>
            <Link href="/login" className="btn-primary text-sm">شروع دمو</Link>
          </div>
        </div>
      </header>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slide-up">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 text-accent-light text-sm font-medium mb-8">
                ...
                نسل جدید خرید ملک با وام
              </div>

              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-[1.15] tracking-tight">
                <span className="text-white">خرید خانه،</span>
                <br />
                <span className="gradient-text">ساده و هوشمند</span>
              </h1>

              <p className="text-slate-400 text-lg md:text-xl mt-8 leading-relaxed max-w-xl">
                پلتفرمی که چهار بازیگر اصلی — خریدار، فروشنده، بانک و ارزیاب — را در یک فرآیند شفاف و یکپارچه به هم متصل می‌کند.
              </p>
            ...
            <div className="relative hidden lg:block animate-fade-in animate-delay-300">
              <div className="relative glass-strong p-8 animate-float">
                ...
                <div className="space-y-4">
                  {[
                    { label: 'پرونده RE-2026-DEMO01', status: 'بررسی بانک', color: 'text-gold' },
                    { label: 'سقف وام تأیید شده', status: '۶.۴ میلیارد ریال', color: 'text-accent-light' },
                    { label: 'ارزیابی ملک', status: 'در انتظار', color: 'text-purple-400' },
                  ].map((row, i) => (
                ...
                <p className="text-xs text-slate-500 mt-2 text-center">پیشرفت پرونده — ۶۰٪</p>
              </div>
              ...
              <div className="absolute -bottom-6 -right-6 glass p-4 animate-float-delayed">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">اعتبارسنجی تأیید</p>
                    <p className="text-xs text-slate-500">بانک ملت · ۲ دقیقه پیش</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-accent-light text-sm font-semibold tracking-wider uppercase mb-3">اکوسیستم</p>
            <h2 className="section-title text-white">چهار بازیگر، یک پلتفرم</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ACTORS.map((a, i) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-white">{a.role}</h3>
      ...
      <section id="process" className="py-24 px-6 relative">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            <p className="text-gold text-sm font-semibold tracking-wider uppercase mb-3">فرآیند</p>
            <h2 className="section-title text-white">از درخواست تا کلید</h2>
          </div>
          ...
          <div className="relative glass-strong p-12 md:p-16 text-center overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                آماده <span className="gradient-text">دمو</span> هستید؟
              </h2>
              <p className="text-slate-400 max-w-lg mx-auto leading-relaxed">
                با ۵ حساب آزمایشی وارد شوید و کل فرآیند را از دید هر نقش — خریدار تا بانک — تجربه کنید.
              </p>
              <p className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 font-mono text-sm text-slate-400">
                رمز عبور: <span className="text-accent-light">123456</span>
              </p>
              <div className="mt-8">
      ...
      <footer className="border-t border-white/5 py-10 flex flex-col items-center">
        <Logo size="sm" />
        <p className="text-sm text-slate-600 mt-4">پلتفرم یکپارچه تأمین مالی و خرید ملک — MVP</p>
      </footer>
    </div>
  );
}
