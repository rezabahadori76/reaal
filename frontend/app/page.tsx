...
const ACTORS = [
  { roleKey: 'actorBuyer', descKey: 'actorBuyerDesc', tone: 'text-blue-300', initial: 'B' },
  { roleKey: 'actorSeller', descKey: 'actorSellerDesc', tone: 'text-emerald-300', initial: 'S' },
  { roleKey: 'actorBank', descKey: 'actorBankDesc', tone: 'text-amber-300', initial: 'K' },
  { roleKey: 'actorAppraiser', descKey: 'actorAppraiserDesc', tone: 'text-violet-300', initial: 'V' },
];
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Navbar */}
      <header className="fixed top-0 inset-x-0 z-50 border-b border-white/10 bg-surface/80 backdrop-blur-xl">
            ...
            <div className="relative hidden lg:block">
              <div className="relative glass-strong p-8 overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <p className="text-sm font-semibold text-white">{t('heroCase')}</p>
                    <p className="text-xs text-slate-500 mt-1">{t('heroApprovedBy')}</p>
                  </div>
                  <span className="badge bg-accent/10 text-accent-light border-accent/20">{t('heroBankReview')}</span>
                </div>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-4 rounded-xl bg-white/[0.04] border border-white/10">
              ...
              <div className="absolute -bottom-6 -right-6 glass p-4">
                <div className="flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ACTORS.map((a, i) => (
              ...
              >
                <div className={`w-12 h-12 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-sm font-bold mb-5 ${a.tone}`}>
                  {a.initial}
                </div>
            ...
            {STEPS.map((step, i) => (
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-accent-light">
                    {step.icon}
                  </div>
                </div>
